...
<p align="center">
  <img src="./aws_serverless_arch.png" alt="Serverless AWS Architecture" width="95%">
</p>
...
<p align="center">
  <img src="./heroku_server_arch.png" alt="Server-ed Heroku Architecture" width="95%">
</p>
...
With the test router, iterating on the application is as simple as running `python3 main.py`, opening `localhost:5000/docs` in the browser, and sending requests from the Swagger UI that is automatically generated by FastAPI.
